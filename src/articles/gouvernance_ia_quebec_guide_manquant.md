---
title: "La gouvernance IA au Québec : le guide que personne n'a encore écrit"
description: "Pendant que nos PME et nos municipalités attendent un cadre clair, le Québec accumule un retard numérique qui ne sera pas facile à effacer."
date: "27 mars 2026"
reading_time: "9 min"
vertical: "Gouvernance IA"
tag: "ARTICLE DE FOND"
...
# La gouvernance IA au Québec : le guide que personne n'a encore écrit
...
> | **12,7 %** | **29 %** | **0** |
> |---|---|---|
> | des entreprises QC utilisent l'IA | des PME mondiales surveillent leurs systèmes IA | cadre opérationnel disponible pour PME et municipalités |
> | *ISQ, 2024–2025* | *Kiteworks, 2025* | *Québec, 2026* |
...
## Le Québec regarde passer le train — et il sait pourquoi
...
## Six questions légitimes — et personne pour y répondre
...
>
> 1. Où seront les données — et dans quelle juridiction?
> 2. Quelle est la confidentialité des données au repos et en transit?
> 3. Les données des clients — et des clients des clients — sont-elles protégées?
> 4. L'usage respecte-t-il la Loi 25 (Québec) et le cadre fédéral (LPRPDE)?
> 5. Quel est le risque concurrentiel et réputationnel en cas d'incident?
> 6. Qui gouverne les données d'utilisation : requêtes, captures d'écran, flux d'agents IA?
...
## Un avis d'urbanisme erroné, et c'est la Ville qui répond
...
## Ce qui existe ne descend pas jusqu'au terrain
...
## Les acteurs sont en mouvement — les municipalités doivent s'y adapter
...
- **Inventaire de risque par cas d'usage**, avec des niveaux de tolérance à l'erreur explicites — nulle pour la fiscalité et l'urbanisme, faible pour la communication publique, acceptable pour l'administration interne.
- **Validation humaine obligatoire** pour tout usage à risque légal ou financier : l'IA prépare, l'humain valide et signe.
- **Intégration aux conventions collectives** avec des mécanismes de réaffectation planifiés avant l'implantation, pas après.
- **Désignation claire du porteur de responsabilité légale** quand un outil IA contribue à une décision : ce n'est pas l'outil qui répond — c'est la personne qui a validé.
- **Standard d'hébergement des données** avec une adresse, une juridiction et un audit annuel visible dans les procès-verbaux du conseil.
...
*Gouvernance IA · PME québécoises · Municipalités · Loi 25 · FQM · UMQ · Saguenay–Lac-Saint-Jean*
