---
title: "Est-ce que le jeûne fait perdre du muscle?"
slug: "jeune-intermittent-perte-muscle"
section: "sante-metabolique"
date: "2026-04-12"
auteur: "Pascal Gagnon"
description: "Non, pas en jeûne court de 16 à 48 heures. Le corps préserve le muscle grâce à une augmentation de l'hormone de croissance et à la lipolyse prioritaire. C'est la restriction calorique chronique qui détruit le muscle — pas le jeûne."
tags: ["jeûne perd muscle", "jeûne intermittent muscle", "catabolisme musculaire jeûne", "jeûne hormone croissance"]
schema_type: "FAQPage"
sources:
  - "Hartman et al., Journal of Clinical Endocrinology & Metabolism, 1992 — HGH et jeûne de 24 heures"
  - "Cahill, Annual Review of Nutrition, 2006 — métabolisme du jeûne et préservation musculaire"
  - "Tinsley & La Bounty, Nutrition Reviews, 2015 — jeûne intermittent et composition corporelle"
# Fichiers dans : pascalgagnon-site/assets/img/sante-metabolique/
image_hero: "jeune-intermittent-perte-muscle-hero.webp"
image_hero_alt: "Homme en forme qui soulève des poids — jeûne intermittent et muscle"
image_info: "jeune-intermittent-perte-muscle-info.webp"
...
## Jeûne vs restriction calorique — deux réalités opposées
...
## Pourquoi le corps préserve le muscle pendant le jeûne — le mécanisme
...
## Ce que tu dois faire pendant ta fenêtre pour préserver le muscle

1. **Mange suffisamment de protéines.** L'objectif minimal : 1,6 g de protéines par kilogramme de poids corporel. Pour un homme de 85 kg, c'est environ 135 g de protéines par jour, répartis dans ta fenêtre alimentaire. Viande, poisson, œufs, fromage — les sources animales sont les plus biodisponibles.
...
3. **Maintiens un minimum d'activité physique.** La masse musculaire se préserve par la stimulation — pas seulement par la nutrition. 2 à 3 séances de résistance par semaine (poids, bandes, travaux physiques) signalent au corps de maintenir le muscle. Pas besoin d'un gym — 20 minutes de poids corporel suffisent.

---

## Questions fréquentes

**Est-ce que jeûner plus de 24 heures fait perdre du muscle?**
...
## Tu veux savoir exactement comment intégrer le jeûne avec ton entraînement?
